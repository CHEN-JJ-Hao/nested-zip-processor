...
class Extractor:
    ...
    def _determine_target_directory(self, file_path, extract_to, base_name):
        ...
        temp_dir = os.path.join(extract_to, "temp_extract")
...
if __name__ == "__main__":
    ...
    if extract_thread and extract_thread.is_alive():
        extractor.stop()
        extract_thread.join()
    if extractor.compression_thread and extractor.compression_thread.is_alive():
        extractor.compression_thread.join()